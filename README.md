...
Wazuh Agent (Target VM) detects suspicious activity.

Wazuh Manager processes the alert.

Alert is forwarded via Wazuh Webhook to Shuffle.
...
The Wazuh Manager processes and stores the alert.

A webhook forwards the alert to Shuffle for automation.
...
The enrichment logic determines:
...
Threaded alerts within 5-minute window
